    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-5">
      <div className="w-full max-w-sm pt-8">
        <div className="mb-10 text-left">
          <h1 className="text-[13px] font-semibold text-text-bright tracking-normal">&gt; activity_tracker_signup</h1>
        </div>
        ...
        <form action={formAction} className="space-y-[24px]">
          ...
          <div>
            <label className="block text-[11px] font-semibold text-text-secondary uppercase tracking-[0.1em] mb-[8px]" htmlFor="fullName">
              Full Name
            </label>
            <input
              id="fullName"
          ...
          <p className="mt-6 text-left text-[11px] font-normal text-muted">
            <Link href="/login" className="text-text-secondary hover:text-text-primary hover:underline transition-colors focus:outline-none focus:ring-1 focus:ring-accent focus:ring-offset-2 focus:ring-offset-background">
              [ back_to_login ]
            </Link>
          </p>
        </form>
